        ...
        <body>
            ...
            <div class="form-group mx-sm-3 mb-2">
                <div class="container">
                    ...
                    <form method="post" action="<?php echo base_url('Mainc/updatev/') . $post->voucherID ?>">
                        <div class="form-group shadow-textarea">
                            <h2>Update Voucher</h2>
                            <textarea class="form-control z-depth-1" id="exampleFormControlTextarea6" rows="1" name="judul" required><?php echo $post->title_voucher ?></textarea>
                        </div>
                        <div class="form-group shadow-textarea">
                            <textarea class="form-control z-depth-1" id="exampleFormControlTextarea6" rows="10" name="isi" required><?php echo $post->isi_voucher ?></textarea>
                        </div>
                        <div class="row">
                            <div class="col-lg-4 mb-2">
                                <div class="form-group shadow-textarea">
                                    <textarea class="form-control z-depth-1" id="exampleFormControlTextarea6" rows="1" name="nilai" required><?php echo $post->voucher_value ?></textarea>
                                </div>
                            </div>
                            <div class="col-lg-4 mb-2">
