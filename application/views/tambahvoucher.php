    ...
    <html lang="en">
        ...
        <body>
            ...
            <div class="form-group mx-sm-3 mb-2">
                <div class="container">
                    <form method="post" action="<?php echo base_url('MainC/tambahv') ?>">
                        <div class="form-group shadow-textarea">
                            <h2>Add New Voucher</h2>
                            <textarea class="form-control z-depth-1" id="exampleFormControlTextarea6" rows="1" placeholder="Voucher name" name="judul" required></textarea>
                        </div>
                        <div class="form-group shadow-textarea">
                            <textarea class="form-control z-depth-1" id="exampleFormControlTextarea6" rows="10" placeholder="Voucher detail" name="isi" required></textarea>
                        </div>
                        <div class="row">
                            <div class="col-lg-4 mb-2">
                                <div class="form-group shadow-textarea">
                                    <textarea class="form-control z-depth-1" id="exampleFormControlTextarea6" rows="1" placeholder="Voucher value" name="nilai" required></textarea>
                                </div>
                            </div>
                            <div class="col-lg-4 mb-2">
